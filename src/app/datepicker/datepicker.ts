...
@Component({
  ...
  template: `
    ...
    <div class="ngb-dp-header mb-1 d-none d-md-block d-lg-block d-xl-block font-weight-bold">
...
@Component({
  ...
  template: `
    <div *ngIf="viewModel.weekdays.length > 0" class="ngb-dp-week ngb-dp-weekdays" role="row">
      ...
      <div *ngFor="let weekday of viewModel.weekdays" class="ngb-dp-weekday" role="columnheader">{{ weekday }}</div>
    </div>
